Классификация отзывов о товарах и услугах. Сравнение показателей точности для разных моделей машинного обучения.

Файл 'text_to_csv.py' содержит вспомогательную программу, которая преобразует три текстовых файла с отзывами в один общий csv-файл, добавляя в каждую строку информацию об источнике отзыва.
